...
const requiredStories: Readonly<Record<string, readonly string[]>> = {
  ...
  Box: ['Default', 'Variants', 'Composition'],
  ToggleButtonGroup: ['Default', 'Variants', 'Composition'],
  TopNavMegaMenu: ['Default', 'Composition'],
  TopNavMenu: ['Default', 'Composition'],
  ButtonGroup: ['Default', 'Variants', 'Composition'],
  ChatComposer: ['Default', 'Composition'],
  ChatLayout: ['Default', 'Composition'],
  ChatMessage: ['Default', 'States', 'Composition'],
  ChatMessageList: ['Default', 'Composition'],
  ChatToolCalls: ['Default', 'Composition'],
  ClickableCard: ['Default', 'Composition'],
  Collapsible: ['Default', 'States', 'Composition'],
  CommandPalette: ['Default', 'Composition'],
  HStack: ['Default', 'Variants', 'Composition'],
  OverflowList: ['Default', 'Composition'],
  PowerSearch: ['Default', 'Composition'],
  Resizable: ['Default', 'Composition'],
  ResizeHandle: ['Default', 'Composition'],
  SelectableCard: ['Default', 'States', 'Composition'],
  ToggleButton: ['Default', 'States', 'Disabled', 'Composition'],
  TreeList: ['Default', 'States', 'Composition'],
  VStack: ['Default', 'Composition'],
  AspectRatio: ['Default', 'Composition'],
  Avatar: ['Default', 'Sizes', 'States', 'Composition'],
  AvatarGroup: ['Default', 'States', 'Composition'],
  Banner: ['Default', 'Tones', 'Composition'],
  Blockquote: ['Default', 'Composition'],
  Carousel: ['Default', 'Composition'],
  Citation: ['Default', 'Composition'],
  CodeBlock: ['Default', 'Composition'],
  Indicator: ['Default', 'Tones', 'Composition'],
  Lightbox: ['Default', 'Composition'],
  Markdown: ['Default', 'Composition'],
  MetadataList: ['Default', 'Variants', 'Composition'],
  ProgressBar: ['Default', 'States', 'Composition'],
  Thumbnail: ['Default', 'Sizes', 'States', 'Composition'],
  Timestamp: ['Default', 'Composition'],
  Token: ['Default', 'States', 'Composition'],
  Tokenizer: ['Default', 'Composition'],
  AlertDialog: ['Default', 'Composition'],
  AsyncState: ['Default', 'States', 'Composition'],
  Badge: ['Default', 'Tones', 'Composition'],
  AppShell: ['Default', 'Composition'],
  Breadcrumbs: ['Default', 'Composition'],
  Layout: ['Default', 'Composition'],
  MobileNav: ['Default', 'Composition'],
  NavIcon: ['Default', 'Composition'],
  NavItem: ['Default', 'States', 'Composition'],
  NavMenu: ['Default', 'Variants', 'Composition'],
  Outline: ['Default', 'Composition'],
  Pagination: ['Default', 'States', 'Composition'],
  SideNav: ['Default', 'Composition'],
  TabList: ['Default', 'States', 'Composition'],
  Toolbar: ['Default', 'Variants', 'Composition'],
  TopNav: ['Default', 'Composition'],
  BottomSheet: ['Default', 'Composition'],
  BottomSheetSwitcher: ['Default', 'Composition'],
  Button: [
    'Default',
    'Variants',
    'Sizes',
  ...
  Calendar: ['Default', 'States', 'Composition'],
  CheckboxInput: ['Default', 'States', 'Disabled', 'Composition'],
  CheckboxList: ['Default', 'States', 'Composition'],
  ComplexSelector: ['Default', 'Composition'],
  DateInput: ['Default', 'States', 'Composition'],
  DateRangeInput: ['Default', 'Composition'],
  DateTimeInput: ['Default', 'Composition'],
  FieldStatus: ['Default', 'Tones', 'Composition'],
  FileInput: ['Default', 'Composition'],
  FormLayout: ['Default', 'Variants', 'Composition'],
  InputGroup: ['Default', 'Composition'],
  MultiSelector: ['Default', 'Composition'],
  NumberInput: ['Default', 'States', 'Composition'],
  RadioList: ['Default', 'States', 'Composition'],
  Selector: ['Default', 'States', 'Composition'],
  Slider: ['Default', 'States', 'Composition'],
  Switch: ['Default', 'States', 'Disabled', 'Composition'],
  TimeInput: ['Default', 'Composition'],
  Typeahead: ['Default', 'States', 'Composition'],
  Code: ['Default', 'Composition'],
  Eyebrow: ['Default', 'Tones', 'Composition'],
  ContextMenu: ['Default', 'Composition'],
  Dialog: ['Default', 'Sizes', 'Composition'],
  DropdownMenu: ['Default', 'Variants', 'Composition'],
  ...
  HoverCard: ['Default', 'Variants', 'Composition'],
  Icon: ['Default', 'Sizes', 'Tones', 'Composition'],
  InternationalizationProvider: ['Default', 'States', 'Composition'],
  IconButton: [
    'Default',
    'Variants',
    'Sizes',
  ...
  Item: ['Default', 'Composition'],
  Kbd: ['Default', 'Composition'],
  Layer: ['Default', 'Composition'],
  Link: ['Default', 'States', 'Composition'],
  LinkProvider: ['Default', 'States', 'Composition'],
  List: ['Default', 'Variants', 'Composition'],
  MetricGrid: ['Default', 'States', 'Composition'],
  Numeral: ['Default', 'Composition'],
  MoreMenu: ['Default', 'Composition'],
  Overlay: ['Default', 'States', 'Composition'],
  Popover: ['Default', 'Variants', 'Composition'],
  ...
  Toast: ['Default', 'Tones', 'Composition'],
  ToastProvider: ['Default', 'States', 'Composition'],
  Toggle: ['Default', 'States', 'Disabled', 'Composition'],
  Tooltip: ['Default', 'Variants', 'Composition'],
