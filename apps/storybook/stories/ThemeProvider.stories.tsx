...
function hostThemeTokens(palette: HostPalette): ThemeDefinition['tokens'] {
  return Object.freeze({
    ...
    'typography.letterSpacingTitle': '0.01em',
    'typography.letterSpacingHeading': '0.02em',
    'typography.letterSpacingBody': '0',
    'typography.letterSpacingLabel': '0.04em',
    'typography.letterSpacingEyebrow': '0.1em',
    'typography.letterSpacingMono': '-0.01em',
    'spacing.xs': '4px',
    'spacing.sm': '8px',
    'spacing.md': '12px',
    'spacing.lg': '16px',
